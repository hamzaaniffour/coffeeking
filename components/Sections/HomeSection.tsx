  ...
  return (
    <div>
      <div className="flex justify-center items-center flex-col">
        <h1 className="text-xl md:text-3xl lg:text-3xl xl:text-3xl text-black font-bold mb-3 text-center">
        ...
        <p className="text-base md:text-xl lg:text-xl xl:text-xl text-black font-semibold text-center max-w-[1000px] mx-auto">
