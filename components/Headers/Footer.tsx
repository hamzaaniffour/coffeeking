          ...
          <div className="lg:flex justify-between gap-10">
            ...
            <h4 className="mb-0.5 text-xl text-[#000000] font-bold uppercase">
              ...
              <ul className="flex justify-start items-center gap-1 mt-4">
                <li><Link href="/" aria-label="Follow us on Facebook"><FaInstagram className="h-6 w-6 text-slate-600 hover:text-[#1877F2]" /></Link></li>
                <li><Link href="/" aria-label="Follow us on Instagram"><FaInstagram className="h-6 w-6 text-slate-600 hover:text-[#1877F2]" /></Link></li>
                <li><Link href="/" aria-label="Follow us on Twitter"><FaInstagram className="h-6 w-6 text-slate-600 hover:text-[#1877F2]" /></Link></li>
                <li><Link href="/" aria-label="Follow us on Pinterest"><FaInstagram className="h-6 w-6 text-slate-600 hover:text-[#1877F2]" /></Link></li>
              </ul>
            </div>
