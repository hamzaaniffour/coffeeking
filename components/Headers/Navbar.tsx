      ...
      {searchVisible && (
        <div className="bg-black bg-opacity-95 fixed w-full h-full z-50 top-0 left-0 right-0 flex items-center justify-center flex-col px-5">
          <form className="w-[500px] mx-auto">
            <h3 className="text-white text-xl font-semibold text-left mb-8">
            ...
            <div className="relative">
              ...
              <input
                type="search"
                id="default-search"
                className="block w-full p-4 ps-10 text-sm text-amber-100 border-b-4 border-gray-300 bg-transparent !outline-none dark:placeholder-gray-400"
                placeholder="Search for articles..."
                required
              />
              <button
                type="submit"
                className="text-slate-900 absolute end-0 bottom-2.5 bg-white focus:ring-4 focus:outline-none font-medium rounded text-sm px-4 py-2"
              >
                Search now
              </button>
            </div>
